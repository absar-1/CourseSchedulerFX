...
public class AddSpecialScheduleController {
    ...
    @FXML
    private void handleCreateSpecialSchedule() {
        // Validate inputs
        ...
        try {
            ...
            // Create special schedule object (ID will be auto-generated)
            ...
            // Try to add special schedule
            if (SpecialScheduleDAO.addSpecialSchedule(specialSchedule)) {
                showMessage("Special schedule created successfully!", "success");
                ...
                showMessage("Failed to create special schedule", "error");
            }

        } catch (Exception e) {
            e.printStackTrace();
            showMessage("Error creating special schedule: " + e.getMessage(), "error");
        }
    }
